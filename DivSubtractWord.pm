...
sub BUILD {
    ...
    my $problem_text_templates = [
            'I have N_THINGS THING_TYPE. I keep N_KEEP and give the rest away to my N_FRIENDS friends, '
          . ' giving each friend the same number of THING_TYPE. \newline '
          . ' How many THING_TYPE does each friend get? ',

        'I had N_THINGS THING_TYPE. I kept N_KEEP and gave the rest away to my N_FRIENDS friends, '
          . ' giving each friend the same number of THING_TYPE. \newline '
          . ' How many THING_TYPE did each friend get? ',

        'I have N_THINGS THING_TYPE. '
          . 'If I kept N_KEEP of them, and gave the rest away, '
          . 'giving the same number of THING_TYPE to each of my N_FRIENDS friends - \newline '
          . 'How many THING_TYPE would each friend get?',

        'My friends saw that I only had N_KEEP THING_TYPE, so each of them gave me N_FRIENDS THING_TYPE, '
...
sub random_problem {
    ...
    $problem_text =~ s/N_THINGS/$n_start/;
